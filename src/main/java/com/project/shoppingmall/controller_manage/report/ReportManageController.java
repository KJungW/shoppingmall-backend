...
import com.project.shoppingmall.service_manage.report.ReportProcessManageService;
...
public class ReportManageController {
  private final ReportProcessManageService reportProcessManageService;
  ...
  public OutputProcessProductReport processProductReport(
    ...
    ProductReport productReport =
        reportProcessManageService.processProductReport(
  ...
  public OutputProcessReviewReport processReviewReport(
    ...
    ReviewReport reviewReport =
        reportProcessManageService.processReviewReport(
