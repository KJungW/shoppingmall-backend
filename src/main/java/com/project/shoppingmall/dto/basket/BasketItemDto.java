...
import com.project.shoppingmall.dto.product.ProductForBasketItemDto;
...
public class BasketItemDto {
  ...
  private ProductForBasketItemDto product;
  ...
  public BasketItemDto(BasketItem basketItem, BasketItemPriceCalcResult calcResult) {
    ...
    this.product = new ProductForBasketItemDto(basketItem.getProduct());
