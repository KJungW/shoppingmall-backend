...
import com.project.shoppingmall.controller.chat.input.InputUpdateChatReadRecord;
...
import com.project.shoppingmall.service.chat.ChatReadRecordService;
...
public class ChatController {
  ...
  public void updateChatReadRecord(@Valid @RequestBody InputUpdateChatReadRecord input) {
    ...
    chatReadRecordService.updateRecord(
        input.getChatRoomId(), userDetail.getId(), input.getChatMessageId());
  }
