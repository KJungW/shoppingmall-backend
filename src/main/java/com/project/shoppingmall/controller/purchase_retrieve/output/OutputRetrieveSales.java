...
@Getter
@AllArgsConstructor
public class OutputRetrieveSales {
  ...
  public OutputRetrieveSales(SliceResult<PurchaseItemDtoForSeller> sliceResult) {
    ...
    this.purchaseItemList = sliceResult.getContentList();
  }
}
