...
public class ProductDeleteIntegrationTest {
  ...
  public void beforeEach() {
    ...
    ProductReport productReport =
        testDataMaker.saveProductReport(buyer, targetProduct, ReportResultType.WAITING_PROCESSED);
    ...
    ReviewReport reviewReport =
        testDataMaker.saveReviewReport(other, review, ReportResultType.NO_ACTION);
